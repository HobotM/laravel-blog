                        ...
                        <tr>
                            ...
                            <td
                                ...
                                <form method="POST" action="/admin/admins/{{ $user->id }}">
                                    ...
                                    <button
                                        class="px-5 py-2 border-red-500 border text-red-500 rounded transition duration-300 hover:bg-red-600 hover:text-white focus:outline-none">Delete</button>
                                </form>
