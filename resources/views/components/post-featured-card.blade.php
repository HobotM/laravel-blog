@props(['post'])
<article
    class="transition-colors duration-300 bg-gray-50 hover:bg-gray-100 bg-opacity-80  border border-black border-opacity-0 hover:border-opacity-5 rounded-xl">
